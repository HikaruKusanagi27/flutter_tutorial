...
// APIの取得の状態を管理
final Provider<PropertyApiClient> propertyApiProvider = Provider((ref) {
  final dio = Dio();
...
// 非同期で管理
final AutoDisposeFutureProvider<List<PropertyItem>> propertyItemProvider =
    FutureProvider.autoDispose<List<PropertyItem>>((ref) {
